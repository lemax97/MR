...
public class LevelScreen extends BaseScreen {
	...
	public void initialize() {
		...
		for (BaseActor room : BaseActor.getList(mainStage, "MR.Room")) {
	...
	public void update(float dt) {
		...
		for (BaseActor wall : BaseActor.getList(mainStage, "MR.Wall")){

			hero.preventOverlap(wall);
		}

		for (BaseActor coin : BaseActor.getList(mainStage, "MR.Coin")) {
		...
		int coins = BaseActor.count(mainStage, "MR.Coin");
